...
export default function VenderListing() {
  ...
  useEffect(() => {
    const filtered = allVenders.filter(v =>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="w-full bg-white rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="space-y-4  pb-4">
            <div className="mb-4">
              <h2 className="text-lg text-gray-600 font-bold mb-2">Search by Shop Name</h2>
              <TextField
